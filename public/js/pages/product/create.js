...
document.addEventListener('DOMContentLoaded', function() {
    ...
    $(document).on('click','#btn-add-more',function () {
        var product_tr = '<tr>\n' +
            ...
            '                    </td>\n' +
            '                    <td>\n' +
            '                        <input name="product['+_no+'][qty]" id="qty" type="number" min="0" step="any" class="form-control" placeholder="ចំនួន">\n' +
            '                    </td>\n' +
            '                    <td>\n' +
            '                        <input name="product['+_no+'][pur_price]" id="purchase" type="number" min="0" step="any" class="form-control" placeholder="តម្លៃទិញ">\n' +
            '                    </td>\n' +
            '                    <td>\n' +
