...
$(document).on('click','#btn-add-more',function () {
    var product_tr = '<tr>\n' +
        ...
        '                    <td>\n' +
        '                        <input name="product['+_no+'][desc]" type="text" class="form-control" placeholder="ពិពណ៌នា">\n' +
        '                    </td>\n' +
        '                    <td>\n' +
        '                        <input name="product['+_no+'][qty]" id="qty" value="1" type="number" min="1" step="any" class="form-control" placeholder="ចំនួន">\n' +
        '                    </td>\n' +
        '                    <td>\n' +
        '                        <input name="product['+_no+'][pur_price]" id="purchase" value="1" type="number" min="1" step="any" class="form-control" placeholder="តម្លៃទិញ">\n' +
        '                    </td>\n' +
        '                    <td>\n' +
        '                        <input name="product['+_no+'][sell_price]" id="sell" type="number" min="1" step="any" class="form-control" placeholder="តម្លៃលក់">\n' +
        '                    </td>\n' +
        '                    <td>\n' +
        '                        <input name="product['+_no+'][amount]" id="amount" readonly type="number" min="1" step="any" class="form-control" placeholder="សរុប">\n' +
        '                    </td>\n' +
        '                    <td>\n' +
