        ...
        <div class="page-header-content header-elements-md-inline">
            ...
            <div class="header-elements d-none">
                <div class="d-flex justify-content-center">
                    <a href="{{route('user.index')}}" class="btn btn-link btn-float text-default"><i class="icon-list-numbered text-primary"></i><span>List</span></a>
                    <a href="{{route('user.create')}}" class="btn btn-link btn-float text-default"><i class="icon-add text-primary"></i> <span>New</span></a>
                </div>
            </div>
        </div>
